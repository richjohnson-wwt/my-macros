...
DailyView::DailyView(IDailyCallback *callback, IFoodListCallback * foodListCallback, FoodListView *foodListView) 
: m_dailyCallback(callback), m_foodListView(foodListView), m_foodListCallback(foodListCallback)
{
}
...
wxPanel *DailyView::createDailyPanel(wxNotebook *parent)
{
    ...
    m_foodRecipeBookCtrl->AddPage(pageRecipe, "Recipes", false, wxID_ANY);
