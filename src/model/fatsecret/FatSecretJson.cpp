...
namespace FatSecret
{
    ...
    SearchFoods FatSecretJson::handleSearchResponse(const std::string &response)
    {
        try {
    ...
    SearchFood FatSecretJson::retrieveFoodById(std::string foodId)
    {
        spdlog::debug("FatSecretJson::retrieveFoodById {}", foodId);
        ...
        spdlog::error("FatSecretJson::retrieveFoodById Food not found");
        return FatSecret::SearchFood();
    }

    GetFood FatSecretJson::handleGetResponse(const string &response)
    {
        json j = json::parse(response);
    ...
    GetFood FatSecretJson::retrieveGetFood(int servingIndex)
    {
